...
from arches_casbin.utils.forms import ArchesCasbinUserCreationForm
from arches.app.models.system_settings import settings
from arches.app.utils.arches_crypto import AESCipher
from arches.app.utils.betterJSONSerializer import JSONSerializer, JSONDeserializer
from arches.app.views.auth import *
from arches_orm.adapter import admin
from arches_casbin.models.models import RegistrationLink
...
class PersonSignupView(View):
    def get(self, request):
        form = ArchesCasbinUserCreationForm(enable_captcha=False)
    ...
    def post(self, request):
        ...
        form = ArchesCasbinUserCreationForm(postdata, enable_captcha=settings.ENABLE_CAPTCHA)
...
class PersonConfirmSignupView(View):
    def get(self, request):
        ...
        with admin():
            ...
            form = ArchesCasbinUserCreationForm(userinfo)
